...
namespace gRPCForConsul.Hosting.Extensions
{
    public static class AppBuilderExtensions
    {
        ...
        // 服务注册
        public static IApplicationBuilder RegisterConsul(this IApplicationBuilder app, IApplicationLifetime lifetime, IOptions<HealthService> healthService, 
            IOptions<ConsulService> consulService)
        {
